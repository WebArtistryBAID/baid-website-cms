...
-- CreateEnum
CREATE TYPE "public"."UserAuditLogType" AS ENUM ('login', 'autoCreatePost', 'writerCreateEntity', 'writerEditEntity', 'editorApproveEntity', 'adminApproveEntity', 'adminPublishEntity', 'writerCreatePage', 'writerEditPage', 'editorApprovePage', 'adminApprovePage', 'adminPublishPage', 'unpublishEntity', 'unpublishPage', 'deleteEntity', 'deletePage', 'uploadImage', 'deleteImage');
